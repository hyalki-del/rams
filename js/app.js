document.addEventListener('DOMContentLoaded', async () => {
    ...
    const inking = new SpatialInkingEngine(canvasContainer, saveLocalState);
    ...
    btnL2.addEventListener('click', () => {
        btnL2.classList.add('active'); btnL3.classList.remove('active');
        inking.setActiveLayer('vector');
    });

    btnL3.addEventListener('click', () => {
        btnL3.classList.add('active'); btnL2.classList.remove('active');
